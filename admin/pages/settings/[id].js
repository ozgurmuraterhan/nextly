...
import { Upload, Space, Image, InputNumber, Button, Card, message, Divider, Col, Form, Input, Row, Select } from "antd";
...
const Default = () => {
      ...
      axios
         ...
         .then((res) => {
            if (res.data.variant == "error") {
               message.error(intl.messages["app.pages.settings.notUpdated"] + res.data.messagge);
            } else {
   ...
   return (
      ...
      <div>
         <Card className="card" title={intl.messages["app.pages.settings.settings"]}>
            <Form
               {...formItemLayout}
               form={form}
               name="add"
            ...
            >
               ...
               >
                  <Select
                     className=" w-full"
                     options={[
                        { label: intl.messages["app.pages.product.start"], value: true },
            ...
            */}
                  ...
                  <Col md={24} >
                     <Row gutter={[20]}>
                        <Col md={8} className="text-end mt-2">
                           <h6><IntlMessages id="app.pages.common.email" />:</h6>
                        </Col>
                        <Col md={16}>
                           <Form.List
                              label={intl.messages["app.pages.common.email"]}
                  ...
                  <Col md={24} >
                     <Row gutter={[20]}>
                        <Col md={8} className="text-end mt-2">
                           <h6><IntlMessages id="app.pages.common.address" />:</h6>
                        </Col>
                        <Col md={16}>
                           <Form.List
                              name="address"
                  ...
                  <Col md={24} >
                     <Row gutter={[20]}>
                        <Col md={8} className="text-end mt-2">
                           <h6><IntlMessages id="app.pages.common.phone" />:</h6>
                        </Col>
                        <Col md={16}>
                           <Form.List
                              name="phone"
