...
import { Upload, InputNumber, Button, Card, message, Divider, Form, Input } from "antd";
		...
		axios
			...
			.then((res) => {
				if (res.data.variant == "error") {
					message.error(intl.messages["app.pages.brands.brandsNotAdded"] + res.data.messagge);
				} else {
