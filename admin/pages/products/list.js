...
import { Card, Drawer, Divider, Form, Radio, Space, Tag, message, Switch, Modal, Table, Popconfirm, Tooltip, Button } from "antd";
import { EditOutlined, DeleteOutlined, AppstoreAddOutlined, UploadOutlined } from '@ant-design/icons';
...
Default.getInitialProps = async ({ req }) => {
  if (!req?.headers?.cookie) {
    ...
    const res = await axios.get(API_URL + "/products", { headers: req ? { cookie: req.headers.cookie } : undefined, });
