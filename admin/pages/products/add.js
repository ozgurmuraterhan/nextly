    ...
    axios
      ...
      .then((res) => {
        if (res.data.variant == "error") {
          message.error(intl.messages["app.pages.product.notAdded"] + res.data.messagge);
        } else {
                        ...
                        {field.map((field2, j) => (
                          <div>
                            ...
                            <div className="float-left">
                              <h5 className="float-left text-xl pr-2"> {j == 0 ? intl.messages["app.pages.common.variants"] : ""} </h5> {field2.display == true ? "" : <Tag color='blue' className="float-left"  >{field2.initialValue}</Tag>}
                            </div>
                            <Form.Item
