...
import { EditOutlined, CheckCircleOutlined, CloseSquareOutlined, AppstoreAddOutlined } from "@ant-design/icons";
...
const Default = ({ getData = [] }) => {
	...
	const activeOrDeactive = (id, deg) => {
		axios.post(`${API_URL}/customers/active/${id}`, { isActive: !deg }).then(() => {
