...
import { Upload, InputNumber, Button, Card, message, Divider, Form, Input, Select } from "antd";
...
const Default = () => {
		...
		axios
			...
			.then((res) => {
				if (res.data.variant == "error") {
					message.error(intl.messages["app.pages.cargoes.notAdded"] + res.data.messagge);
				} else {
	...
	return (
		...
		<div>
			<Card className="card" title={intl.messages["app.pages.cargoes.companyAdd"]}>
				<Form
					{...formItemLayout}
					form={form}
					name="add"
