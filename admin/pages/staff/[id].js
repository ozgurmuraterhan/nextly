...
import { Upload, Button, Card, message, Divider, Popconfirm, Checkbox, Form, Input, Select, } from "antd";
		...
		axios
			...
			.then((res) => {
				...
				if (res.data.variant == "success") {
					...
					message.error(intl.messages["app.pages.staff.notUpdated"] + res.data.messagge);
				}
