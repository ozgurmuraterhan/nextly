...
import { Upload, Button, Card, message, Divider, Checkbox, Form, Input, Select, } from "antd";
      ...
      axios
         ...
         .then((res) => {
            if (res.data.variant == "error") {
               message.error(intl.messages["app.pages.staff.notAdded"] + res.data.messagge);
            } else {
               const staffUpdate = res.data;

               staffUpdate["created_user"] = { name: res.data.data.name + " " + res.data.data.surname, id: res.data.data._id };
            ...
            >
               ...
               <Form.Item
                  ...
                  rules={[
                     ...
                     {
                        required: true,
                        message: intl.messages["app.userAuth.The input is not valid E-mail!"],
                     },
                  ]}
               >
                  <Input />
               ...
               <Form.Item
                  ...
                  rules={[
                     {
                        message: intl.messages["app.userAuth.Please input your Password!"],
                     },
                  ]}
                  hasFeedback
               >
                  ...
                  rules={[
                     ...
                     ({ getFieldValue }) => ({
                        validator(rule, value) {
                           ...
                           return Promise.reject(intl.messages["app.pages.customers.passwordNotMatch"]);
                        },
                     }),
                  ]}
               >
