...
router.route("/").get((req, res, next) => {
    ...
    Settings.find().then(val => {
        if (val.length > 0) {
            ...
            Settings.insertMany(settingsData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Users.find().then(val => {
        if (val.length > 0) {
            ...
            Users.insertMany(usersData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Variants.find().then(val => {
        if (val.length > 0) {
            ...
            Variants.insertMany(variantsData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Turkey.find().then(val => {
        if (val.length > 0) {
            ...
            Turkey.insertMany(turkeyData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Topmenu.find().then(val => {
        if (val.length > 0) {
            ...
            Topmenu.insertMany(topmenuData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Products.find().then(val => {
        if (val.length > 0) {
            ...
            Products.insertMany(productsData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Productimages.find().then(val => {
        if (val.length > 0) {
            ...
            Productimages.insertMany(productimagesData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Paymentmethods.find().then(val => {
        if (val.length > 0) {
            ...
            Paymentmethods.insertMany(paymentmethodsData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Orderstatus.find().then(val => {
        if (val.length > 0) {
            ...
            Orderstatus.insertMany(orderstatusData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Orders.find().then(val => {
        if (val.length > 0) {
            ...
            Orders.insertMany(ordersData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Homeslider.find().then(val => {
        if (val.length > 0) {
            ...
            Homeslider.insertMany(homesliderData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Country.find().then(val => {
        if (val.length > 0) {
            ...
            Country.insertMany(countryData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Categories.find().then(val => {
        if (val.length > 0) {
            ...
            Categories.insertMany(categoriesData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Cargoes.find().then(val => {
        if (val.length > 0) {
            ...
            Cargoes.insertMany(cargoesData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
    ...
    Brands.find().then(val => {
        if (val.length > 0) {
            ...
            Brands.insertMany(brandsData, function (err, result) {
                if (err) {
                    console.log(err)
                } else {
